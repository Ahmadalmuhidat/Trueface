...
class Lecture:
  def __init__(
    ...
    academic_career: str = None, course: str = None,
    offering_nbr: str = None, start_time: str = None,
    end_time: str = None, section: str = None,
    component: str = None, campus: str = None,
    instructor: Instructor = None, day: str = None
  ) -> None:
